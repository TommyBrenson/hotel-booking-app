    ...
    <footer className='footer'>
          ...
          <div className='footer-item footer-item--logo'>
            <div className='footer-logo'>
              ...
              <p className='footer-logo__text'>
                Бронирование номеров в лучшем отеле 2022 года по версии ассоциации «Отельные взгляды»
              </p>
            </div>
          </div>
      ...
      <Container>
        <div className='footer-bottom'>
          <p className='footer-copyright'>Copyright © 2022 Toxin отель. Все права защищены.</p>
        </div>
      </Container>
    </footer>
  );
